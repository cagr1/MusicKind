...
6. [ ] **Lote 3** (`design/SPEC.md` § Lote 3): M1 selección sin barra + lazy [x] · M2 agregar archivos siempre [x] · M3 icono nuevo [x] · M5 selección y limpiar tabla · M4 reproductor tipo deck.
