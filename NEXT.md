...
9. [~] **Lote 6 — Clasificar por ejemplos** (`design/SPEC.md` § Lote 6). **PAUSADO 2026-09-24 a pedido de Carlos.**
   ...
   - Pendiente después: E0b (entrenar audio con las ~2,300 etiquetadas para sugerir en las ~190 sin tag).
...
**Siguiente (2026-09-25):** E0b → punto final. QA de Carlos en Electron cuando pueda.
