...
1h. [ ] **U4** tablas responsive (regresión U3 a 900 px), quitar filas en Clasificador por etiquetas, Convertidor sin «General», Stems (destino en vez del nombre duplicado, transporte en resultados). Spec `design/SPEC.md` § U4.
