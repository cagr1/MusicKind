...
9. [~] **Lote 6 — Clasificar por ejemplos** (`design/SPEC.md` § Lote 6). **PAUSADO 2026-09-24 a pedido de Carlos.**
   ...
   - [ ] **Back 1c** (siguiente, spec por escribir): libkeyfinder como motor de respaldo en `resolve_key` (el tag sigue mandando). Decidir con Carlos: pista entera (6 s) vs 120 s (2 s), y cómo empaquetar `libkeyfinder` (GPL-3, Homebrew) para distribuir.
